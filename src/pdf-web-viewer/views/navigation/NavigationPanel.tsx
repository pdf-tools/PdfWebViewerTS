...
/** @internal */
export const NavigationPanel: Component<{}, PdfWebViewerState, PdfWebViewerActions> = ({ }) => (state, actions) => (
  <div class="pwv-navigation-panel">
    <div>
      <ul class="pwv-tab-nav">
        {state.options.enableThumbnailNavigation &&
          <li class={classNames({ 'pwv-active': state.navigationPanel.selectedNavigation === 'pages' })}>
            <button
        ...
        {state.options.enableOutlineNavigation &&
          <li class={classNames({
            'pwv-active': state.navigationPanel.selectedNavigation === 'outline',
      ...
      {state.options.enableThumbnailNavigation &&
        <div
          class={classNames(
            'pwv-tab-content',
            { 'pwv-tab-content-selected': state.navigationPanel.selectedNavigation === 'pages' },
          )}
        >
          <ThumbnailNavigation
            pages={state.navigationPanel.pages}
            isVisible={state.navigationPanel.showNavigation && state.navigationPanel.selectedNavigation === 'pages'}
            ...
            onLoadThumbnails={(fromPage, toPage) => {
              actions.api.addPageRangeToThumbnailsQueue({ from: fromPage, to: toPage })
            }}
          />
        </div>
      }
      ...
      {state.options.enableOutlineNavigation &&
        <div
          class={classNames(
            'pwv-tab-content',
            { 'pwv-tab-content-selected': state.navigationPanel.selectedNavigation === 'outline' },
          )}
        >
          <OutlineNavigation />
        </div>
